...
A ver unprofessional tutorial explaining how to use ZDoom-based sourceports like GZDoom or UZDoom to play multiplayer Doom. Naturally, this is very useful for heavily modded playthroughs with friends. Due to it's superior performance and maintenance, UZDoom is used in all the examples.
